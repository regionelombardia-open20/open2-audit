...
use open20\amos\audit\components\panels\Panel;
...
class Audit extends Module
{
    ...
    private $_corePanels = [
        ...
        'audit/request'    => ['class' => 'open20\amos\audit\panels\RequestPanel'],
        'audit/db'         => ['class' => 'open20\amos\audit\panels\DbPanel'],
        'audit/log'        => ['class' => 'open20\amos\audit\panels\LogPanel'],
        'audit/asset'      => ['class' => 'open20\amos\audit\panels\AssetPanel'],
        'audit/config'     => ['class' => 'open20\amos\audit\panels\ConfigPanel'],
        'audit/profiling'  => ['class' => 'open20\amos\audit\panels\ProfilingPanel'],

        // Special other panels
        'audit/error'      => ['class' => 'open20\amos\audit\panels\ErrorPanel'],
        'audit/javascript' => ['class' => 'open20\amos\audit\panels\JavascriptPanel'],
        'audit/trail'      => ['class' => 'open20\amos\audit\panels\TrailPanel'],
        'audit/mail'       => ['class' => 'open20\amos\audit\panels\MailPanel'],
        'audit/extra'      => ['class' => 'open20\amos\audit\panels\ExtraDataPanel'],
        'audit/curl'       => ['class' => 'open20\amos\audit\panels\CurlPanel'],
        'audit/soap'       => ['class' => 'open20\amos\audit\panels\SoapPanel'],
    ];
    ...
    /**
     * @var \open20\amos\audit\models\AuditEntry If activated this is the active entry
     */
    private $_entry = null;
